...
namespace Dolittle.AspNetCore.Debugging.Handlers
{
    ...
    public interface ICanHandlePostRequests<T>
        where T : class
    {
        /// <summary>
        /// The method that gets called when a POST request is recieved for an <see cref="IDebuggingHandler"/>.
        /// </summary>
        ...
        Task HandlePostRequest(HttpContext context, T artifact);
    }
}