...
namespace Dolittle.AspNetCore.Debugging.Artifacts.Events
{
    ...
    /// hi ther.
    /// </summary>
    public class EventDebuggingHandler : IDebuggingHandler, ICanHandlePostRequests<IEvent>
    {
        readonly IEventStore _eventStore;

        /// <summary>
        /// Initializes a new instance of the <see cref="EventDebuggingHandler"/> class.
        /// nice.
        /// </summary>
        /// <param name="events">hie.</param>
        /// <param name="eventStore">nioe.</param>
        public EventDebuggingHandler(IArtifactMapper<IEvent> events, IEventStore eventStore)
        {
